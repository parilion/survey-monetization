...
-- ============================================
-- 创建示例问卷
INSERT INTO `surveys` (`title`, `description`, `intro_text`, `total_questions`, `status`) VALUES
('你是哪种香水性格?', '通过30道题目,测试你的独特香水性格', '欢迎来到香水性格测试! 通过简单的30道题目,我们将为你揭示你的独特性格特质。请根据真实感受作答,没有对错之分。', 30, 1);
